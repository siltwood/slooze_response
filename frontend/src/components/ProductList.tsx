      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span>{groupByCategory ? t.groupedView : t.listView}</span>
          </button>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center space-x-2">
                        ...
                        <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                          ({categoryProducts.length} {t.products.toLowerCase()})
                        </span>
                      </h3>
                      <div className="flex items-center space-x-4">
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                          {t.totalValue}: ${categoryProducts.reduce((sum, p) => sum + (p.price * p.stock), 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </div>
                        {hasMore && (
                          <button
                          ...
                          >
                            <span>{isExpanded ? t.showLess : `${t.showMore} (${categoryProducts.length - 3})`}</span>
                            {isExpanded ? (
                      ...
                      {displayedProducts.map((product) => (
                        ...
                        >
                              ...
                              {isManager && (
                                <>
                                  ...
                                  <button
                                    ...
                                    title={t.delete + ' ' + t.product.toLowerCase()}
                                  >
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              <span className="text-sm text-gray-600 dark:text-gray-400">{t.price}:</span>
                              <span className="font-medium text-gray-900 dark:text-white">
                                ${product.price.toFixed(2)}
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="text-sm text-gray-600 dark:text-gray-400">{t.stock}:</span>
                              <div className="flex items-center space-x-1">
